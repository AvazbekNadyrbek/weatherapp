              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    itemCount: data.hourlyForecast
                        .length, // используем длину списка из модели
                    scrollDirection: Axis.horizontal,
                    itemBuilder: (context, index) {
                      final hourData = data
                          .hourlyForecast[index]; // получаем данные из модели

                      return HourlyForecastItem(
                        time: DateFormat.Hm().format(hourData.time),
                        temperature: hourData.temperature.toString(),
                        icon: hourData.sky == 'Clouds' || hourData.sky == 'Rain'
                            ? Icons.cloud
                            : Icons.sunny,
                      );
                    },
